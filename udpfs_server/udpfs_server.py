...
class UdpfsServer:
    ...
    def __init__(self, root_dir: Optional[str] = None,
        ...
        # Discovery advertisement: shown in the PS2 loader's server picker.
    ...
    def _info_payload(self) -> bytes:
        """
        Optional name + shares payload appended to an INFORM so the PS2 loader
        can list servers by friendly name. Old clients read only the 6-byte
        INFORM header and ignore this. Padded to a multiple of 4 bytes because
